    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
      <SectionReveal>
        <h2 className="font-serif text-4xl lg:text-5xl font-bold mb-6">
          Ready to elevate your chess?
        </h2>
        <p className="text-primary-foreground/60 text-lg mb-10 max-w-xl mx-auto">
          Whether you're a beginner looking to learn the fundamentals or an experienced
          player aiming for the next level, let's work together to unlock your potential.
        </p>
